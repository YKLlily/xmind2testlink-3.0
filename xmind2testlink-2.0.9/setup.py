...
Documentation
-------------
xmind2testlink2 is a tool to help you convert xmind file to testlink recognized xml files,
...
def command_line():
    target = "xmind2testlink2.main:main"
    entry_points = []
    entry_points.append("xmind2testlink2=%s" % target)
    return entry_points


def main():
    setup(
        name="xmind2testlink2",
